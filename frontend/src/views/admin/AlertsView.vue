  ...
  <div>
    ...
    <template v-if="tab === 'alerts'">
      <section class="card mb-5 overflow-x-auto">
        ...
        <table class="table-base min-w-[760px]"><thead><tr><th>规则</th><th>触发条件</th><th>范围</th><th>通知</th><th>状态</th><th class="text-right">操作</th></tr></thead>
      ...
      <section class="card overflow-x-auto">
        ...
        <table class="table-base min-w-[800px]"><thead><tr><th>事件</th><th>账号</th><th>首次 / 最近</th><th>投递</th><th>状态</th><th class="text-right">操作</th></tr></thead>
