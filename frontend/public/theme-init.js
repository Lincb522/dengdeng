try {
  ...
  const preset = ['dengdeng', 'folio', 'signal'].includes(savedPreset) ? savedPreset : 'dengdeng'
  const layouts = { dengdeng: 'rail', folio: 'topbar', signal: 'compact' }
  const densities = { dengdeng: 'comfortable', folio: 'balanced', signal: 'compact' }
  const browserColors = {
