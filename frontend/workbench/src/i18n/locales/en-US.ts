export default {
    meta: {
        title: "Image Workbench · DengDeng AI",
        description: "DengDeng AI image workbench",
    },
    ...
    creationLibrary: {
        title: "Creation Library",
        search: "Search prompts, rules, or skills",
        use: "Use",
        empty: "No matching items",
        tabs: { prompts: "Built-in prompts {{count}}", rules: "Rules {{count}}", skills: "Skills {{count}}" },
        modes: { all: "All", image: "Image", video: "Video", text: "Text", audio: "Audio" },
        types: { rule: "Rule", skill: "Skill" },
    },
    assets: {
        title: "My Assets",
