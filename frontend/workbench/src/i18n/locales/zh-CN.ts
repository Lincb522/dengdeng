export default {
    meta: {
        title: "图像工作台 · DengDeng AI",
        description: "DengDeng AI 图像工作台",
    },
    theme: { toggle: "切换主题" },
    common: {
        cancel: "取消",
    ...
    creationLibrary: {
        ...
        use: "使用",
        empty: "没有匹配内容",
        tabs: { prompts: "内置提示词 {{count}}", rules: "规则 {{count}}", skills: "Skill {{count}}" },
        modes: { all: "全部", image: "图像", video: "视频", text: "文本", audio: "音频" },
        types: { rule: "规则", skill: "Skill" },
    },
    assets: {
        title: "我的资产",
